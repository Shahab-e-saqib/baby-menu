...
import { CODEX_CANCEL_RESUME_PATH_ENV, readCodexModel } from "./config.js";
...
runAdapter(
  new CodexDriver({
    model: readCodexModel() ?? undefined,
    resumeThreadPath: process.env[CODEX_CANCEL_RESUME_PATH_ENV],
  }),
  "codex-adapter",
);
